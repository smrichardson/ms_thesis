...
\noindent We also need to make some assumptions about how the reward model handles these latent variables. In particular, we assume that the reward model lacks any interaction effects between $W$ and $\xi$ or $Z$ and $\xi$.
